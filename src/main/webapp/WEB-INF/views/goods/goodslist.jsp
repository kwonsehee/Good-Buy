...
<body>
 <section id="gbSection">
       ...
       <div id="pageArea">
            ...
            <c:if test="${pi.currentPage > 0}">
            	<c:url var="start" value="${contextPath }/goods/list">
            ...
            <c:if test="${pi.currentPage > 0 }">
            	<c:url var="before" value="${contextPath }/goods/list">
			...
			<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
				...
				<c:if test="${ p ne pi.currentPage }">
					<c:url var="pagination" value="${contextPath }/goods/list">
            ...
            <c:if test="${pi.currentPage < pi.maxPage }">
            	<c:url var="after" value="${contextPath }/goods/list">
            		<c:param name="page" value="${pi.currentPage +1}"/>
            	</c:url>
           		 <a href="${ after }"> &gt;&nbsp; </a>
            </c:if>
            ...
            <c:if test="${pi.currentPage < pi.maxPage  }">
            	<c:url var="end" value="${contextPath }/goods/list">
